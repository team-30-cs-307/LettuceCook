...
class CustomAdapterRecipeShared extends ArrayAdapter<RecipeListViewItem> implements View.OnClickListener {
    ...
    public CustomAdapterRecipeShared(ArrayList<RecipeListViewItem> recipeSet, Context context, String house){
            ...
            viewHolder.trash_button.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    dr.get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                        @Override
                        public void onSuccess(DocumentSnapshot documentSnapshot) {
                            String tempo = documentSnapshot.getString("friends");
                            ...
                            for(int i=0; i<friends.size(); i++){
                                ...
                                final DocumentReference drf = db.collection("Household").document(friends.get(i));
